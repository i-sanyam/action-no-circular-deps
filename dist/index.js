...
module.exports = eval("require")("./validate-circular-deps");
...
/* harmony import */ var _validate_circular_deps__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(805);
...
async function run() {
  try {
    ...
    await _validate_circular_deps__WEBPACK_IMPORTED_MODULE_1__({
      baseCircularDependencies: [],
    });
  } catch (error) {
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed(error.message);
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed('✖ Failed!');
    process.exitCode = 2;
  }
}
